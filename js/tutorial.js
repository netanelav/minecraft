...
function welcome() {
    $('.text')[0].innerHTML = 'Welcome to the Minecraft tutorial! In this game you can move tiles and change the environment you see on screen with specific tools.';
    ...
    setTimeout(function () { $('.text')[0].innerHTML = 'The third tool is the axe, it only works with leaf and tree.'; }, 22000);
    setTimeout(function () { $('.text')[0].innerHTML = 'If the tool you select is not compatible with the tile you selected, the tool will flash red.'; }, 26000);
